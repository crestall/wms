 ...
 class Ebay
 {
    ...
    public function __construct(Controller $controller)
    {
        ...
        if($this->isLive)
        {
            ...
            $this->serverUrl  = 'https://open.api.ebay.com';
