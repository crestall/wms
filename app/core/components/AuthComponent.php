...
class AuthComponent extends Component{
    ...
    public function isLoggedIn(){
      ...
      * @throws Exception if isAuthorized method doesn't exist in the controller class
      * @return boolean
      */
    ...
    private function loggedIn(){
        ...
        if (Cookie::isCookieValid()) {
            ...
            Session::reset([
                ...
                "is_production_user"    => $this->controller->user->isProductionUser(Cookie::getUserId()),
                "is_warehouse_user"     => $this->controller->user->isWarehouseUser(Cookie::getUserId())
            ]);
