...
class PbaRukketGolfShopify extends Shopify
{
    ...
    public function __construct($controller)
    {
        ...
        $this->config = array(
            ...
            'ApiKey'         => Config::get('PBARUKKETGOLFSHOPIFYAPIKEY'),
            'Password'       => Config::get('PBARUKKETGOLFSHOPIFYAPIPASS')
        );

        $from_address = Config::get("FSG_ADDRESS");
        $this->from_address_array = array(
            'name'      =>  'Rukket Golf (via FSG 3PL)',
    ...
    public function getOrders()
    {
        ...
        $this->ua = (isset($this->controller->request->params['args']['ua']))?$this->controller->request->params['args']['ua']:"FSG";
        $this->output = "=========================================================================================================".PHP_EOL;
        $this->output .= "Performance Brands Australia - RUKKET ORDER IMPORTING FOR ".date("jS M Y (D), g:i a (T)").PHP_EOL;
        $this->output .= "=========================================================================================================".PHP_EOL;
        ...
        {
                Email::sendPBAShopifyImportSummary($this->return_array,"Rukket");
        }
