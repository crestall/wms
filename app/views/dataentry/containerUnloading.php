            ...
            <div class="col">
                <form id="container_unloading" method="post" action="/form/procContainerUnload">
                    <div class='form-group row'>
                        ...
                        <div class="col-md-4">
                            <select id="client_id" name="client_id" data-style="btn-outline-secondary" data-live-search="true"><option value="0">--Select One--</option><?php echo $this->controller->client->getSelectClients(Form::value('client_id'));?></select>
