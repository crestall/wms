...
<div id="page-wrapper">
    <div id="page_container" class="container-xxl">
        ...
        <div class="row">
            <div class="col-12">
                <form id="pickup_search" method="post" action="/form/procDeliverySearch">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 offset-md-8">
                            <a class="btn btn-outline-danger" href="/deliveries/delivery-search">Clear Search and Reset Form</a>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="col-12">
                    ...
                    <?php if(count($deliveries)):?>
                        ...
                        <div class="row" id="table_holder" style="display:none">
                            ...
                            <div class="col-12">
                                <?php include(Config::get('VIEWS_PATH')."layout/page-includes/view_deliveries_table.php");?>
                            </div>
                        </div>
                    <?php else:?>
                        <div class="errorbox">
                            ...
                            <?php if(!empty($term)):?>
                                <p>No Deliveries were found when searching against "<strong><?php echo $term;?></strong>"</p>
                            <?php endif;?>
