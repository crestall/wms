...
<div id="page-wrapper">
    <div id="page_container" class="container-xxl">
        ...
        <div id="print_docket_holder" class="mt-2 mb-3 p-2 border border-secondary rounded bg-info">
        ...
        <div id="putaway_holder" class="mt-2 mb-3 p-2 border border-secondary rounded bg-info">
