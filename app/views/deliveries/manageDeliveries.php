...
<div id="page-wrapper">
    <div id="page_container" class="container-xl">
        ...
        <div class="row view-orders-buttons" >
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <p><a class="btn btn-sm btn-block btn-outline-success directfreight-fulfill"><i class="fas fa-clipboard-check"></i> Fulfill Selected Deliveries</a></p>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <select id="client_selector" class="form-control selectpicker" data-style="btn-outline-secondary"><option value="0">All Clients</option><?php echo $this->controller->client->getSelectDeliveryClients($client_id);?></select>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="form-group">
