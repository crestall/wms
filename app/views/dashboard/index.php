            ...
            <div class="card-deck homepagedeck">
                ...
                <?php if($user_role == "production"):?>
                    ...
                    <div class="card homepagecard">
                        ...
                        <div class="card-body text-center">
                        	<a class="btn btn-lg btn-outline-fsg" href="/finishers/view-finishers"><span class="fa-layers fa-fw fa-3x align-middle"><i class="fad fa-people-arrows"></i><i class="fal fa-binoculars" data-fa-transform="sshrink-6 up-2 right-6 rotate-30"></i></span>&nbsp;<span style="font-size:larger">Look!</span></a>
                        </div>
                    </div>
                    <div class="card homepagecard">
                        <div class="card-header">
