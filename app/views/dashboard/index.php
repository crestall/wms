        ...
        <?php elseif($user_role == "production" || $user_role == "production_admin"):?>
            ...
            <div class="card-deck homepagedeck">
                <div class="card homepagecard">
                    ...
                    <div class="card-body text-center">
                    	<a class="btn btn-lg btn-outline-fsg" href="/jobs/add-job"><span class="fa-layers fa-fw fa-3x"><i class="fad fa-tasks"></i><i class="far fa-plus" data-fa-transform="shrink-4 up-3 right-4"></i></span>&nbsp;<span style="font-size:larger"><span class="align-middle">Add</span></span></a>
                    </div>
                </div>
                <div class="card homepagecard">
                    <div class="card-header">
