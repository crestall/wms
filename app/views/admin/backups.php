                                ...
                                <table id="backups" class="table table-hover">
                                    ...
                                    <tbody>
                                       <tr>
											...
											?>
											<td>
												<strong class="text-<?php echo (empty($isBackupExists))? "danger": "primary"; ?>">
													<?php echo $data["filename"]; ?></strong>
											</td>
											<td><em><?php echo $data["date"]; ?></em></td>
											<td>
											   <span class="btn-group btn-group-sm">
													<a href="<?php echo PUBLIC_ROOT . "Admin/updateBackup" . 
										   ...
										   <td>
											   <span class="btn-group btn-group-sm">
													<a href="<?php echo PUBLIC_ROOT . "Admin/restoreBackup" . 
														"?csrf_token=" . urlencode(Session::generateCsrfToken()); ?>"  
