...
<div id="page-wrapper">
    ...
    <div class="row">
        <form id="add-storechain"  method="post" enctype="multipart/form-data" action="/form/procStoreChainAdd">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Add New Type</h3>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary">Add Store Chain</button>
                </div>
            </div>
        </form>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <h2>Current Store Chains</h2>
        </div>
    </div>
    <?php if(count($chains)):?>
        <div class="row">
            <?php foreach($chains as $c):?>
                <form class="edit-storechain" action="/form/procStoreChainEdit" method="post">
                    <div class="form-group row">
                        <div class="col-md-3">
    ...
    <?php else:?>
        <div class="row">
            <div class="col-lg-12">
                <div class="errorbox">
                    <h2><i class="fas fa-exclamation-triangle"></i> No Store Chains Listed</h2>
