<?php
    if($active == 0)
    {
            $link_text = "<a href='/clients/view-clients' class='btn btn-primary'>View Active Locations</a>";
    }
    else
    {
            $link_text = "<a href='/clients/view-clients/active=0' class='btn btn-warning'>View Inactive Locations</a>";
    }
    $i = 1;
?>
<div id="page-wrapper">
