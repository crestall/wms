<div id="page-wrapper">
    ...
    <?php if(count($summary)):?>
        ...
        <div class="row" id="table_holder" style="display:none">
            <div class="col-lg-12">
                <table id="goods_out_summary" class="table-striped table-hover" width="100%">
                    <thead>
                    	<tr>
                            <th>Client</th>
                            <th>Total Pallets</th>
    ...
    <?php else:?>
        <div class="row">
            <div class="col-lg-12">
                <div class="errorbox">
                    <h2><i class='far fa-times-circle'></i>No Goods Out Listed</h2>
                    <p>There is no outwards goods recorded between <?php echo date("d/m/Y", $from);?> and <?php echo date("d/m/Y", $to);?></p>
