<div id="page-wrapper">
    <div id="page_container" class="container-xl">
        ...
        <form id="add-job-status"  method="post" enctype="multipart/form-data" action="/form/procFinisherCategoryAdd">
            <div class="row">
                <div class="col-lg-12">
                ...
                <form class="edit-category mb-3 p-3 border rounded" action="/form/procCategoryEdit" method="post" id="category_<?php echo $c['id'];?>">
                    <div class="form-group row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control required" name="name_<?php echo $c['id'];?>" id="name_<?php echo $c['id'];?>" value="<?php echo ucwords($c['name']);?>" />
