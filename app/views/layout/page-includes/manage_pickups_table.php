    ...
    <tbody>
        <?php foreach($pickups as $d):
            ...
            <tr>
                ...
                <td class="middle">
                    <a id="print_docket_<?php echo $d['id'];?>" class="btn btn-block btn-outline-secondary" role="button" target="_blank" href="/pdf/printPickupDocket/pickup=<?php echo $d['id'];?>">Print Pickup Docket</a>
