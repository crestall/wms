    ...
    <tbody>
        <?php foreach($deliveries as $d):
            ...
            <tr>
                ...
                <td class="middle">
                    <a class="btn btn-sm btn-block btn-outline-fsg" target="_blank" href="/pdf/printDeliveryPickslip/delivery=<?php echo $d['id'];?>">Print Pickslip</a>
                    <a class="btn btn-sm bt-block btn-outline-fsg" href="/deliveries/manage-delivery/delivery=<?php echo $d['id'];?>">Manage</a>
                </td>
            </tr>
        <?php endforeach;?>
    </tbody>
