        ...
        <?php foreach($deliveries as $d):
            ...
            <tr>
                ...
                <td class="middle">
                    ...
                    <button <?php if($d['status_id'] < $this->controller->delivery->onboard_id) echo "disabled";?> id="delivery_completed_<?php echo $d['id'];?>" class="btn btn-block btn-outline-success delivery_completed" data-deliveryid="<?php echo $d['id'];?>">Mark As Complete</button>
                </td>
            </tr>
        <?php endforeach;?>
    </tbody>
