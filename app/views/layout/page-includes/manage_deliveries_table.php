        ...
        <?php foreach($deliveries as $d):
            ...
            <tr>
                ...
                <td class="middle">
                    ...
                    <button id="delivery_completed_<?php echo $d['id'];?>" class="btn btn-block btn-outline-success delivery_completed" data-deliveryid="<?php echo $d['id'];?>">Mark As Complete</button>
                </td>
            </tr>
        <?php endforeach;?>
    </tbody>
