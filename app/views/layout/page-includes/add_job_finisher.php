...
<div id="finisher_<?php echo $i;?>" class="p-3 light-grey mb-3 afinisher">
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <a data-finisher="<?php echo $i;?>" class="remove-finisher" style="cursor:pointer" title="Leave Only First"><h4><i class="fad fa-times-square text-danger"></i> Remove This Finisher</a></h4>
        </div>
    </div>
    <div class="form-group row">
