    ...
    <tbody>
        <?php foreach($jobs as $job):?>
            <tr id="tr_<?php echo $job['id'];?>">
                ...
                <?php endif;?>
                ><select class="selectpicker status" id="status_<?php echo $job['id'];?>" data-style="btn-outline-secondary btn-sm"><option value="0">--Select One--</option><?php echo $this->controller->jobstatus->getSelectJobStatus($job['status_id']);?></select></td>
