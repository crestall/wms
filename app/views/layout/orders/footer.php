        ...
        <script>
            ...
            var actions = {
                ...
                'order-importing': {
                    init:function(){
                        $("button#oneplate_full_import, button#nuchev_full_import, button#freedom_full_import, button#pbawoocommerce_full_import, button#pbashopify_full_import, button#pbappgshopify_full_import, button#pbavcshopify_full_import, button#pbahcgshopify_full_import").click(function(e){
