                    ...
                    init: function(){
                        ...
                        function selectCallback(event, ui)
                        {
                            ...
                            if(ui.item.palletized > 0)
                            {
                                ...
                                qty_html += "<select class='form-control selectpicker pallet_qty' data-style='btn-outline-secondary' name='items["+ui.item.item_id+"][qty]'><option value='0'>Quantity</option>";
