                    ...
                    $("input#item_searcher").autocomplete({
                        ...
                        select: function(event, ui) {
                            ...
                            locations.forEach(function (location, ind)
                            {
                                ...
                                html += "<div class='col-1'><input id='location_"+loc_array[1]+"' class='item_selector select_"+ui.item.item_id+"' name='items["+ui.item.item_id+"][]' value='"+loc_array[1]+"_"+loc_arra[0]+"' type='checkbox'></div>";
                            });
                            html += "</div>"
                            html += "</div>";
