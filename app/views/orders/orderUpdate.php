                                ...
                                <?php if($order['status_id'] == $this->controller->order->fulfilled_id):?>
                                    <div class="feedbackbox">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p><a data-orderid="<?php echo $order_id;?>" class="reprintdflabel btn btn-outline-secondary directfreight-label-print" target="_blank">Reprint Direct Freight Label</a></p>
                                        </div>
                                    </div>
                                    </div><!--End Card Body-->
