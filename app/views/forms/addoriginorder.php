            ...
            <div class="form-group row">
                <div class="form-checkbox">
                    ...
                    <div class="col-md-8 checkbox checkbox-default">
                        <input class="required" type="radio" id="tin" name="roof_type" <?php if(Form::value('roof_type') == "tin") echo 'checked';?> value="tin" />
                        <label for="tin"> Tin</label>
                    </div>
                    <div class="col-md-3">&nbsp;</div>
                    <div class="col-md-8 checkbox checkbox-default">
                        <input type="radio" id="tile" name="roof_type" <?php if(Form::value('roof_type') == "tile") echo 'checked';?> value="tin" />
