                    ...
                    <?php if(is_array(Form::value('banks'))):?>
                        <?php foreach(Form::value('banks') as $b => $bank):
                            ...
                            <div class="row bank_holder">
                                ...
                                <?php endif;?>
                                <div class="col-sm-4">
                                    <p><input type="text" class="form-control number banks" name="banks[<?php echo $i;?>][qty]" placeholder="Panel Count" value="<?php echo $qty;?>" /> Panels</p>
                                </div>
                            </div>
                        <?php endforeach;?>
                    <?php else:?>
                        <div class="row bank_holder">
                            <div class="col-sm-4">
                                <p><input type="text" class="form-control number banks" name="banks[0][qty]" placeholder="Panel Count" /> Panels</p>
                            </div>
                            <div class="col-sm-1 add-image-holder">
                                <a class="add" style="cursor:pointer" title="Add Another Bank">
                                    <i class="fas fa-plus-circle fa-2x text-success"></i>
