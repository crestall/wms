...
<div class="row">
    <div class="col-lg-12">
        <form id="add_origin_order" method="post" action="/form/procOriginOrderAdd"  enctype="multipart/form-data" autocomplete="off">
            ...
            <!--div class="form-group row">
                <div class="form-radio">
                    <label class="col-md-3 col-form-label" for="battery">Battery Install</label>
                    <div class="col-md-2 checkbox checkbox-default">
                        <input type="checkbox" name="battery" id="battery" <?php if(isset(Form::value('battery'))) echo 'checked';?> />
