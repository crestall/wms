    ...
    <div class="col-lg-12">
        <form id="add_order" method="post" action="/form/procOrderAdd"  enctype="multipart/form-data" autocomplete="off">
            ...
            <div id="item_selector" class="p-3 mb-2 bg-secondary text-white row">
                ...
                <div class="col-md-4">
                    <a id="add-item" style="cursor:pointer" title="Add Another Item"><h4><i class="fad fa-plus-square fa-2x text-success"></i> Add another</a></h4>
                </div>
                <div class="col-md-4">
                    <a id="remove-all-items" style="cursor:pointer" title="Remove All Items"><h4><i class="fad fa-times-square fa-2x text-danger"></i> Remove all</a></h4>
                </div>
            </div>
