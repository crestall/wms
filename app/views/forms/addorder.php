        ...
        <form id="add_order" method="post" action="/form/procOrderAdd"  enctype="multipart/form-data" autocomplete="off">
            ...
            <?php else:?>
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <select id="client_id" name="client_id" class="form-control selectpicker" required><option value="0">--Select One--</option><?php echo $this->controller->client->getSelectClients($client_id);?></select>
