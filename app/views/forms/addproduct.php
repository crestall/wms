...
<div class="row">
    <form id="add_product"  method="post" enctype="multipart/form-data" action="/form/procProductAdd">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <select id="preferred_pick_location_id" name="preferred_pick_location_id" class="form-control selectpicker"><option value="0">--Select One--</option><?php echo $this->controller->location->getSelectLocations(Form::value('preferred_pick_location_id'));?></select>
            </div>
        </div>
        <div class="form-group row">
