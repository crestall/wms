...
<div class="col-12">
    <form id="job_order_search" method="get" action="/jobs/job-search-results">
        ...
        <div class="form-group row">
            <label class="col-md-2 col-xl-1 mb-xs-3">Filter By Customer</label>
            <div class="col-md-4 col-xl-2 mb-xs-3">
            ...
            <label class="col-md-2 col-xl-1 mb-xs-3">Filter By Supplier</label>
            <div class="col-md-4 col-xl-2 mb-xs-3">
            ...
            <label class="col-md-2 col-xl-1 mb-xs-3">Filter By Sales Rep</label>
            <div class="col-md-4 col-xl-2 mb-xs-3">
            ...
            <label class="col-md-2 col-xl-1 mb-xs-3">Filter By Status</label>
            <div class="col-md-4 col-xl-2 mb-xs-3">
