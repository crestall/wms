<table width="100%" style="font-size:16px; margin: 0 auto; border: thin solid black">
    <tr style="white-space:nowrap; height: 27mm">
    <?php
    $this_order = 1;
    foreach($orders_ids as $id):
        ...
        if($this_order % 16 == 0)
            echo "</tr></table><pagebreak/><table width='100%' style='font-size:16px'><tr style='white-space:nowrap; height: 27mm'>";
        elseif($this_order % 2 == 0)
            echo '</tr><tr style="white-space:nowrap; height: 27mm">';
        ?>
