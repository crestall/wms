    ...
    <div id="page_container" class="container-xxl">
        ...
        <?php if(count($jobs)):?>
            ...
            <div class="row mt-4" id="table_holder" style="display:none">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-3"><a class="btn btn-sm btn-block btn-outline-primary driver-runsheet"><i class="fas fa-truck"></i> Add Selected to Chosen Driver's Runsheet</a></div>
                <div class="col-12">
