...
$padmin = array(
    ...
    'runsheets' => array(
        ...
        'finalise-runsheets'    => array(
            'display'   => true,
            'icon'      => '<div class="fa-2x"><span class="fa-layers fa-fw"><i class="fad fa-list-ol"></i><i class="fal fa-check" data-fa-transform="up-2 right-4" style="color:#66ff33"></i></span></div>'
        )
    ),
