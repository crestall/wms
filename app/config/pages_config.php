...
$client = array(
    'deliveries'    => array(
        ...
        'view-pickups'   => array(
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-thin fa-truck-fast"></i><i class="fal fa-binoculars" data-fa-transform="shrink-6 up-2 right-6 rotate-30"></i></span></div>'
        ),
        'delivery-search' =>  array(
            'display'   => true,
            'icon'      => '<div class="fa-3x"><i class="fad fa-file-search"></i></div>'
