...
$padmin = array(
    ...
    'runsheets' => array(
        ...
        'runsheet-report'    => array(
            'display'   => true,
            'icon'      => '<div class="fa-2x"><span class="fa-layers fa-fw"><i class="fad fa-list-ol"></i><i class="fal fa-file-chart-line data-fa-transform="right-4 shrink-4 up-2"></i></span></div>'
        )
    ),
