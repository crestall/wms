...
$prod = array(
    'jobs'  => array(
        ...
        'view-jobs' => array(
            'display'   => true,
            'icon'      => '<div class="fa-2x"><span class="fa-layers fa-fw"><i class="fad fa-tasks"></i><i class="far fa-search" fa-inverse data-fa-transform="shrink-4 up-1 right-4"></i></span></div>'
        ),
    )
);
