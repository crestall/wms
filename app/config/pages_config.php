...
$padmin = array(
    'jobs'  => array(
        'add-job'   => array(
            'display'   => true,
            'icon'      => '<div class="fa-2x"><span class="fa-layers fa-fw"><i class="fad fa-tasks"></i><i class="fal fa-plus" data-fa-transform="shrink-4 down-3 right-4" style="color:green"></i></span></div>'
        ),
    )
);
