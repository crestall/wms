...
$padmin = array(
    ...
    'production-settings'   => array(
        ...
        'job-status'    => array(
            ...
            'icon'      => 'div class="fa-2x"><span class="fa-layers fa-fw"><i class="fal fa-list-alt fa-2x"></i><i class="fad fa-pencil-alt" data-fa-transform="shrink-4 up-3 right-4"></i></span></div>'
        ),
