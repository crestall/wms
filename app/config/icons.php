...
$fontastic_icons = array(
    ...
    'financials'    => array(
        ...
        'pickpack-client-charges'   => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-thin fa-box-open-full"></i><i class="fad fa-usd-circle" data-fa-transform="shrink-4 up-3 right-2"></i></span></div>' 
    ),
    'finishers' => array(
