...
$fontastic_icons = array(
    ...
    'orders'    => array(
        ...
        'order-search'  => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fal fa-shopping-cart"></i><i class="fas fa-search" dat-fa-transform="up-6 left-2 rotate-30"></i></span></div>',
