...
$fontastic_icons = array(
    ...
    'deliveries'   => array(
        ...
        'delivery-search'   => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-thin fa-truck-fast"></i><i class="fa-solid fa-magnifying-glass" data-fa-transform="shrink-6 up-2 left-4 rotate-60"></i></span></div>',
