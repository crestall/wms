...
$fontastic_icons = array(
    ...
    'deliveries'   => array(
        'pickup-search'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-thin fa-flip-horizontal fa-truck-fast"></i><i class="fa-solid fa-magnifying-glass" data-fa-transform="shrink-6 up-2 right-2"></i></span></div>',
