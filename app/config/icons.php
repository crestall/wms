...
$fontastic_icons = array(
    ...
    'financials'    => array(
        ...
        'delivery-client-charges'   => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fal fa-truck"></i><i class="fad fa-usd-circle" data-fa-transform="shrink-4 up-1"></i></span></div>'
    ),
    'finishers' => array(
