...
$fontastic_icons = array(
    ...
    'orders'    => array(
        ...
        'order-search'  => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fal fa-shopping-cart"></i><i class="fas fa-search" data-fa-transform="shrink-4 up-6 right-2 rotate-180"></i></span></div>',
