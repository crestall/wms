...
$fontastic_icons = array(
    ...
    'orders'    => array(
        ...
        'view-orders'   => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fal fa-shopping-cart"></i><i class="fal fa-binoculars" data-fa-transform="shrink-6 up-2 right-6 rotate-30"></i></span></div>'
    ),
    'runsheets' => array(
