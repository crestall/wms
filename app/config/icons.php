...
$fontastic_icons = array(
    ...
    'items-collections' => array(
        'record-collection' => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-boxes-packing"></i><i class="far fa-plus" data-fa-transform="shrink-4 up-4 right-4 rotate-10"></i></span></div>',
