...
$fontastic_icons = array(
    ...
    'orders'    => array(
        ...
        'back-orders'   => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fal fa-exchange" data-fa-transform="shrink-4 up-2 left-6"></i><i class="fal fa-truck"></i></span></div>'
    ),
    'runsheets' => array(
