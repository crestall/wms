...
class Validation {
    ...
    /**
     * check if password has at least 3 of
     * - lowercase letter
     * - uppercase letter
     * - number
    ...
    private static function defaultMessages($rule){
        $messages = [
            ...
            "password"      => "Passwords must contain at least three of the following: lowercase character, uppercase character, number or special character",
